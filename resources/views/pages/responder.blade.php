...
<!-- Responder Modal -->
<div class="modal fade bs-modal-lg" id="modal-select-responder" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-red clearfix">
				<div class="tools pull-right">
					<a href="javascript:;" class="tool-close"><i class="retina-the-essentials-024"></i></a>
				</div>
				<!-- <button type="button" class="btn-close modal-select-responder-close" data-dismiss="modal" aria-hidden="true"></button> -->
				<h4 class="modal-title">SELECT UNITS FOR DISPATCH</h4>
			</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn blue modal-select-responder-close">DONE</button>
			</div>
		</div>
	</div>
</div>

<script type="text/template" id="responder-template">
<tr>
	<td><%= id %></td>
	<td><%= name %></td>
	<td><%= contact %></td>
	<td><%= distance %></td>
	<td><button type="button" data-id='<%= id %>' class="btn green assign-responder"><i></i> <span>ASSIGN</span></button></td>
</tr>
</script>
...
<div class="detail-container">
	<div class="col1">
		<div class="dispatcher-container box-border responder">
			<div class="box-header">
				...
				<div class="od-status">
					...
					<div class="btn-group status-select">
						...
						<span class="ticket-status">Open</span> <i class="fa fa-angle-down"></i>
						</a>
			...
			<div class="d-content">
				<ul id="dispatch-note-parent" class="no-style dispatch-note-parent responder-dispatch-note">
					
				</ul>
			</div>
		</div>
		<div class="original-details-container box-border responder">
			<div class="box-header">
				<div class="od-title bold uppercase">ORIGINAL DETAILS</div>
			</div>
			...
			<div class="od-attachment clearfix">
		...
		<div class="form-group dispatcher-btn-container clearfix">
			<button type="submit" class="btn green dispatcher-btn" id="btn-select-responders">SELECT UNITS</button>
			<button type="submit" class="btn blue dispatcher-btn" id="units-selected"><span>0</span> UNITS SELECTED</button>
		</div>
	</div>
	<div class="col2">
		<div id="mini-map" class="mini-map box-border"></div>
		<div class="chat-box box-border dipatcher-log">
			<div class="box-header bold uppercase chat-box-title">Dispatcher Logs</div>
